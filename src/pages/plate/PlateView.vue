<template>
    ...
    <q-page class="oa-root-div" :style-fn="pageStyleFnForBreadcrumbs">
            ...
            <oa-section v-else :title="plate.barcode" icon="view_module" :collapsible="true">
                <div class="row q-pa-md">
                    ...
                    <div class="col-2">
                        ...
                        <div class="row justify-end">
                            <q-btn size="sm" color="primary" icon="delete" class="oa-action-button" label="Delete" @click="showDeleteDialog = true"/>
                        </div>
                        <div class="row justify-end">
                            <q-btn size="sm" color="primary" icon="calculate" class="oa-action-button" label="Recalculate" @click="showCalculateDialog = true"/>
                        </div>
                    </div>
                </div>
            </oa-section>
        ...
        <rename-dialog v-model:show="showRenameDialog" objectClass="plate" fieldName="barcode" :object="plate" @valueChanged="onNameChanged" />
        <delete-dialog ref="deleteDialog" v-model:id="plate.id" v-model:name="plate.barcode" v-model:show="showDeleteDialog" :objectClass="'plate'" @onDeleted="onDeleted"/>

<template>
  ...
  >
    <div class="q-pa-sm">
      ...
      <oa-section
        v-else
        :title="plateStore.plate.barcode"
        icon="view_module"
        :collapsible="true"
      >
        <div class="row q-pa-sm">
          ...
          <div class="col-3">
            <q-field label="Dimensions" stack-label borderless dense>
              <template v-slot:control>
                {{ plateStore.plate.rows }} x {{ plateStore.plate.columns }} ({{
                  plateStore.plate.rows * plateStore.plate.columns
                }}
                wells)
              </template>
            </q-field>
          ...
          <div class="col-4">
            <PropertyTable
              :properties="plateStore.plate.properties"
              :read-only="readOnly"
    ...
    <delete-dialog
      ...
      :id="plateStore.plate.id"
      :name="plateStore.plate.barcode"
      :objectClass="'plate'"
      @onDeleted="onDeleted"
    />

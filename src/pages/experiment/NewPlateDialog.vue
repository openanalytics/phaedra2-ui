  ...
  <q-dialog v-model="showDialog">
    <q-card style="min-width: 50vw">
      ...
      <q-card-actions align="right" class="text-primary">
        ...
        <q-btn label="Add plate" v-close-popup color="primary" @click="createNewPlate"/>
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
...
const createNewPlate = async () => {
  ...
  await loadingHandler.handleLoadingDuring(experimentStore.addPlate(newPlate.value))
  clearValues()
}
</script>

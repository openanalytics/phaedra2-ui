<template>
  ...
  >
        ...
        <div class="row q-pa-md oa-section-body">
          <div class="col-4 q-gutter-xs">
            ...
            <div class="row">
              ...
              <div class="col">{{ feature.alias }}</div>
            </div>
            <div class="row">
    ...
    <edit-feature
      ...
      v-model:originalFeature="feature"
    ></edit-feature>
    ...
    <delete-dialog
      ref="deleteDialog"
      v-model:id="feature.id"
      v-model:name="feature.name"
      :objectClass="'feature'"
      @onDeleted="onDeleted"
    />
  </q-page>
...
const protocol = computed(() =>
  store.getters["protocols/getById"](feature.value.protocolId)
);
const formula = computed(() =>
  store.getters["calculations/getFormula"](feature.value.formulaId)
);
const formulaInputs = computed(() => {
  return store.getters["calculations/getFormulaInputs"](
    feature.value.formulaId
  );
});

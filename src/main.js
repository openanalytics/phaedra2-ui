...
import FormulaeView from "@/pages/calculation/formulae/FormulaeView";
import FormulaView from "@/pages/calculation/formulae/FormulaView";
...
const routes = [
    ...
    { name: "calcFormulae", path: "/calc/formulae", component: FormulaeView },

start kubectl port-forward -n phaedra2 "service/phaedra-plate-service" 6010:8080
start kubectl port-forward -n phaedra2 "service/phaedra-metadata-service" 6020:8080
